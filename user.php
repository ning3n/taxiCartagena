						...
						<div class="col-md-6">
							<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Realizar Solicitud:</h4>
								</div>
								<div class="form-body">
									<form action=cliente.php method=post> 
										<div class="form-group"> 
											<label for="exampleInputEmail1">Punto de Origen</label> 
											<input type="text" class="form-control" id="Desde" name="desde" placeholder="Desde que Lugar"> 
										</div> 
										<div class="form-group"> 
											<label for="exampleInputEmail1">Punto de Destino</label> 
											<input type="text" class="form-control" id="Hasta" name="hasta" placeholder="Hasta que Lugar"><input type=hidden name=id value="<?php echo $id;?>" > 
										</div> 
										<button type="submit" value = "Solicitar" class="btn btn-default">Solicitar</button> 
									</form> 
								</div>
							</div>
						</div>
